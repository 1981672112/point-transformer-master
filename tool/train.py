...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='/home/lh/point_cloud/test7_PT/point-transformer-master/config/s3dis/s3dis_pointtransformer_repro.yaml', help='config file')
